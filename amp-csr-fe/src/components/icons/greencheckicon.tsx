...
export default function GreenCheckIcon() {
	return (
		<svg width="20" height="20" viewBox="0 0 30 30" version="1.1" xmlns="https://www.w3.org/2000/svg" fill="#000000">
			<g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
			<g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
			<g id="SVGRepo_iconCarrier">
				<title>check</title> <desc>Created with Sketch.</desc>
				<defs>
				...
				<g id="icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
					<g id="ui-gambling-website-lined-icnos-casinoshunter" transform="translate(-735.000000, -1911.000000)" fill="url(#linearGradient-1)" fillRule="nonzero">
